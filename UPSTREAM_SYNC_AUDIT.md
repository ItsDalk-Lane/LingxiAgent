...
| VERIFIED_SOURCE_SHA | `cc697956e64507867bf8956e3c2999213e1320cb` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树；2026-08-23 品牌图标/logo 全量替换，去方形外框改透明主体） |
