...
| VERIFIED_SOURCE_SHA | `563478a0269dd8cdd9f5661273432447842f85c1` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 同上 + build underscore 钉依赖修复 + Windows 测试关库修复 |
