...
| VERIFIED_SOURCE_SHA | `2e7798aebb2b1bbfdaf7c15cf75477e083f2baef` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-28 PR #29 knowledge-notebook + provider-compat + CI 修复 |
