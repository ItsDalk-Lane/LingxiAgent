...
| VERIFIED_SOURCE_SHA | `57d716e5c3fc49573a8fba7765c78c6d49e86055` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 同上 + Windows 轮询测试真实时间预算修复 |
