...
| VERIFIED_SOURCE_SHA | `52d29b3c43585b4ea91457b1c86ec6b1d7b955a1` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-28 PR #29 knowledge-notebook + provider-compat + CI 修复（两轮） |
