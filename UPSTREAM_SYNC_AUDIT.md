...
| VERIFIED_SOURCE_SHA | `ea03c6276347391388dbda886d25137e80bfb7de` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-09-02 模型调用统一 + 视频上传闭环 + 工作台继承 |
