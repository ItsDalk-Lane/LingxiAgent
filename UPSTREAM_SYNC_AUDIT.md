...
| VERIFIED_SOURCE_SHA | `aac8c605ceed05a6907af34412e7326fe5422d45` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-23 品牌资产最终范围：应用图标原样，其余透明无框 |
