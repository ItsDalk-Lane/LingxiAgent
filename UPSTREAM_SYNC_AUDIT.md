...
| VERIFIED_SOURCE_SHA | `e76918ef5fa1e2db606ca4efbde2209eefd2d2bf` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-24 Linux /tmp redaction 修复 |
