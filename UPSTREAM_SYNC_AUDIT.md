...
| VERIFIED_SOURCE_SHA | `0a45563a2c8f440f54cc93e4daf6c659701ae9e1` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 同上 + build 修复 underscore 钉入外置传递依赖 |
