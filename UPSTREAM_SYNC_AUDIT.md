...
| VERIFIED_SOURCE_SHA | `69d69ca8869349f68682e3e3d9db7dae6ba10ab6` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-25 聊天界面布局重构 + 上下文用量分类详情 |
