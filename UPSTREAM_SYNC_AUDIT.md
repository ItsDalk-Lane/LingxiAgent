...
| VERIFIED_SOURCE_SHA | `66a141557311b694f98c81ae5ef12bf9909e5d75` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-09-02 安全双件套（注入扫描+跑飞守卫）与沙盒拒绝分因文案 |
