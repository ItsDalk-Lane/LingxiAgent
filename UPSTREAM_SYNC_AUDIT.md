...
| VERIFIED_SOURCE_SHA | `7cddd56376199c7687401011ddac1ed80b21cc1f` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 模型操作原生协议 + 用户打标签 + knowledge v9 向量保留（PR #30）+ Windows CI 稳定性三连修 |
