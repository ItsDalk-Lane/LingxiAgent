...
| VERIFIED_SOURCE_SHA | `cc6315e0faae2102443f1576de15a9aa0fe831a2` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-09-02 embedding gate Windows 粒度派发修复 |
