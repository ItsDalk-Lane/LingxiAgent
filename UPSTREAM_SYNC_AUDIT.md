...
| VERIFIED_SOURCE_SHA | `850bf49e578612f16544806982931f80d083b0ee` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-09-02 v0.1.33 release metadata |
