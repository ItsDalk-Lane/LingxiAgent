...
| VERIFIED_SOURCE_SHA | `3b347a4fc023630ba0247e26b635608e74691410` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树；2026-08-23 徽章去框范围修正，图标/logo 还原原样） |
