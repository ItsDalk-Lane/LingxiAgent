...
| VERIFIED_SOURCE_SHA | `87249ede84f52e7cbf4533f8b99178dcc87b0fe6` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-25 v0.1.31 release 元数据 |
