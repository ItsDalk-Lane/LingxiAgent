...
| VERIFIED_SOURCE_SHA | `0cf94f450de105d121e4fa8b6795dee7978ce9cc` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 同上 + 拆解优化 P0-P2 + 注入预算实践上限 96k（修证据装满预算致预填充 77s） |
