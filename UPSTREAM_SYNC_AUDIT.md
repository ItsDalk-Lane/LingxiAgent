...
| VERIFIED_SOURCE_SHA | `08ead330e7a6f3bf46d7b67d54c40c54b0fae2e6` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-30 同上 + 嵌入/重排供应商协议兼容修复（千问双端点方言/MiniMax 方言/rerank 上限 50） |
