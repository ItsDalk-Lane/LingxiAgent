...
| VERIFIED_SOURCE_SHA | `9f4942058667c0301f15475bdb4b9a9e5776a6eb` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树；坐标一律为 commit 对象，第八轮 tree sha 之误见 Phase 10 F-4） |
