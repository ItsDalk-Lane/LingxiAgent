...
| VERIFIED_SOURCE_SHA | `a4048480622da11b009608f83520f6ab78f0bae3` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-31 知识问答重构 + 过程可见二轮（knowledge_trace 逐行广播拆解/检索阶段） |
