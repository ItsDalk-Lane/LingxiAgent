...
| VERIFIED_SOURCE_SHA | `b2785643753f7ab64b15a36dd378316269fbd9e1` | 2026-09-12 v0.1.39 发布候选（工具展示链路五项对抗审查缺陷修复 + 审查材料入库 + 发布元数据 version 0.1.39/gen 17，分支 feat/tool-activity-presentation）；验证证据见 PROGRESS.md 最新条目 |
