...
| VERIFIED_SOURCE_SHA | `9953308de1d51b56651294973efc2ee6d776208a` | 2026-09-08 发布工作流残留引用修复候选（分支 fix/remove-build-packages-workflow-refs）；验证证据见 PROGRESS.md 最新条目 |
