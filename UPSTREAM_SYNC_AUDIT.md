...
| VERIFIED_SOURCE_SHA | `81cdb2d86f8bc226baffe925b886096fd98b2c5f` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树；坐标一律为 commit 对象，第八轮 tree sha 之误见 Phase 10 F-4） |
