...
| VERIFIED_SOURCE_SHA | `7de8ed8e0e47b39282f0c8e7d8140fa1cc6bfcb3` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-28 PR #29 knowledge-notebook + provider-compat + CI 修复（四轮） |
