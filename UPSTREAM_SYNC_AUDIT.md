...
| VERIFIED_SOURCE_SHA | `c031078864c50bb5ecf7e6b07b2827c469740938` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-31 知识问答重构 + 过程可见三轮（过程行堆为等待态本体，answer-pending 行盖住预填充） |
