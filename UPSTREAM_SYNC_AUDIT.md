...
| VERIFIED_SOURCE_SHA | `7010fb06fed37596cb63ea14b41debfb1c45ac3e` | 最终验证（typecheck/lint/测试/构建/打包）所针对的 feature commit（其 tree 即被验证源码树）；2026-08-24 v0.1.30 release 元数据提交 |
