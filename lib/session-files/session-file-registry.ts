...
export function sessionFilesCacheDir(lingxiHome, sessionRef) {
  if (!lingxiHome) throw new Error("lingxiHome is required for session file cache");
  ...
  return path.join(lingxiHome, "session-files", hash);
}
