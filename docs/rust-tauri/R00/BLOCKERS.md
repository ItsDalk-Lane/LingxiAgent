...
生成：`docs/rust-tauri/R00/r00_t07_build_map.py`｜基准 HEAD `4401afae2ee48df1512b8a8c9a1262be0efbe64f`｜配套账本 `ACCEPTANCE_MAP.json`。
...
| ledger_status NOT_STARTED | 185 |
| ledger_status PASS | 30 |
