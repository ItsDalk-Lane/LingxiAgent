...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@lingxi/plugin-protocol': path.resolve(__dirname, 'packages/plugin-protocol/src/index.ts'),
      '@lingxi/plugin-sdk': path.resolve(__dirname, 'packages/plugin-sdk/src/index.ts'),
      '@lingxi/plugin-runtime': path.resolve(__dirname, 'packages/plugin-runtime/src/index.ts'),
      '@lingxi/plugin-components': path.resolve(__dirname, 'packages/plugin-components/src/index.ts'),
