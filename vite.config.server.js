...
// LINGXI_SERVER_BUNDLE_ENTRY lets a caller (scripts/build-server-phases.mjs's
...
const bundleEntry = process.env.LINGXI_SERVER_BUNDLE_ENTRY || "server/main-full.ts";
...
export default defineConfig({
  build: {
    lib: {
      ...
      // routes). LINGXI_SERVER_BUNDLE_ENTRY overrides this for other
