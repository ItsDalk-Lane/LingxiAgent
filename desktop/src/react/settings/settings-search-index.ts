...
const BUILT_IN_SETTINGS_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  {
    id: 'usage-observability-token',
    tabId: 'usage',
    subTabId: 'usage',
    titleKey: 'settings.observability.subtab.usage',
    pathKeys: ['settings.tabs.usage'],
    aliases: ['token', 'usage', 'token usage', '用量', 'token 用量', 'token 统计', '缓存命中', 'cache hit'],
  },
  {
    id: 'usage-observability-ledger',
    tabId: 'usage',
    subTabId: 'ledger',
    titleKey: 'settings.observability.ledger.title',
    pathKeys: ['settings.tabs.usage'],
    aliases: ['ledger', 'call ledger', 'calls', '台账', '调用台账', '调用记录', '调用列表'],
  },
  {
    id: 'usage-observability-settings',
    tabId: 'usage',
    subTabId: 'settings',
    titleKey: 'settings.observability.subtab.settings',
    pathKeys: ['settings.tabs.usage'],
    aliases: ['recording', 'recording settings', 'storage', 'retention', '记录设置', '设置', '存储', '保留天数', '清理', '删除数据'],
  },
  {
    id: 'usage-observability-traces',
    tabId: 'usage',
    subTabId: 'traces',
    titleKey: 'settings.observability.trace.title',
    pathKeys: ['settings.tabs.usage'],
    aliases: ['trace', 'traces', 'trajectory', '轨迹', '调用轨迹', '轨迹详情'],
  },
  {
    id: 'models-auxiliary',
    tabId: 'models',
  ...
  },
  {
    id: 'envdeps',
    tabId: 'envdeps',
    titleKey: 'envDeps.title',
    pathKeys: ['settings.tabs.envdeps'],
    aliases: ['environment', 'dependencies', 'python', 'node', 'git', 'lsp', 'semgrep', '环境', '依赖', '运行时'],
  },
  {
    id: 'about-updates',
    tabId: 'about',
