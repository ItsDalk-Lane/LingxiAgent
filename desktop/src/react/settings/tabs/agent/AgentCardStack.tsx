...
import { lingxiFetch, lingxiUrl, yuanFallbackAvatar } from '../../api';
            ...
            >
              <div className={styles['agent-card-inner']}>
                <img
                  ...
                  draggable={false}
                  src={agent.hasAvatar
                    ? lingxiUrl(`/api/agents/${agent.id}/avatar${agent.avatarRevision ? `?v=${encodeURIComponent(agent.avatarRevision)}` : ''}`)
