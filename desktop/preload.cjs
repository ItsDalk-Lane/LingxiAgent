...
contextBridge.exposeInMainWorld("hana", {
  ...
  keybindingsReloadGlobal: () => ipcRenderer.invoke("keybindings:reload-global"),
  keybindingsTestRegister: (shortcut) => ipcRenderer.invoke("keybindings:test-register", shortcut),
