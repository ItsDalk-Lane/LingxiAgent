# phase C 摘要 — 历史读取可信追加增量更新与真实路由验证（C03/C04/C05）

- 生成：2026-09-10T12:06:04.524Z｜HEAD `1d42b7405c76292f617291e3a01cd2f3ef5efd04`｜分支 `fix/pending-sep10`｜seed 20260910｜页大小 50
...
|---|---|---|---|---|---|
| n=1000 | 13.6 / 14.2 / 14.2 | 0.84 / 1.16 / 1.36 | 20 | 21 / 31 / 28 | overlap=0 missing=0 |
| n=10000 | 94.5 / 102.0 / 102.0 | 0.65 / 0.85 / 4.87 | 200 | 201 / 239 / 213 | overlap=0 missing=0 |
...
|---|---|---|---|---|---|---|---|---|---|
| n=1000 | 0 | 0 KiB | 103 | 0 | 103 | 0.00 | 0.09 | 0.000 | 0.71 |
| n=10000 | 0 | 0 KiB | 103 | 0 | 103 | 0.00 | 0.08 | 0.000 | 0.51 |
...
|---|---|---|---|---|---|---|---|---|
| 1000 | append-1 | 142 | 1 | 101 | 1 | 0 | 2.51 | 50 |
| 1000 | append-10 | 1385 | 10 | 99 | 1 | 0 | 1.78 | 50 |
| 1000 | append-100 | 14135 | 100 | 150 | 1 | 0 | 3.41 | 50 |
| 1000 | append-big-tool-result | 204929 | 1 | 51 | 1 | 0 | 2.87 | 50 |
| 10000 | append-1 | 143 | 1 | 101 | 1 | 0 | 1.62 | 50 |
| 10000 | append-10 | 1385 | 10 | 99 | 1 | 0 | 2.79 | 50 |
| 10000 | append-100 | 14135 | 100 | 150 | 1 | 0 | 18.75 | 50 |
| 10000 | append-big-tool-result | 204929 | 1 | 51 | 1 | 0 | 3.32 | 50 |

开放 Run（1000 规模独立会话，500 条）逐条追加 20 次：单次 serverTotalMs 离散度 max/min = 1.43×（判定线 ≤8×，无 O(Run) 批量改写证据）

开放 Run（10000 规模独立会话，500 条）逐条追加 20 次：单次 serverTotalMs 离散度 max/min = 1.37×（判定线 ≤8×，无 O(Run) 批量改写证据）
