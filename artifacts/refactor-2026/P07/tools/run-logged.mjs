#!/usr/bin/env node
/**
 * P07 命令日志记录器（复制自 P00 同款工具，stage_id=P07）（92 模板 §3）。
...
const LOG_DIR = path.join(ROOT, "artifacts", "refactor-2026", "P07", "logs");
...
try { sourceSha = execFileSync("git", ["rev-parse", "HEAD"], { cwd: ROOT, encoding: "utf-8" }).trim(); } catch { /* 非 git 环境 */ }
