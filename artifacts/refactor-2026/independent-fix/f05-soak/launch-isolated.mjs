...
const out = path.join(repo, 'artifacts/refactor-2026/independent-fix/f05-soak');
const isolated = fs.mkdtempSync(path.join(os.tmpdir(), 'lingxi-f05-soak-'));
