# phase B 摘要 — 历史读取目录快路径（B06/B07 生产接线 + B08 冷构建）

- 生成：2026-09-22T02:39:32.345Z｜HEAD `1d42b7405c76292f617291e3a01cd2f3ef5efd04`｜分支 `fix/pending-sep10`｜seed 20260910｜页大小 50
...
|---|---|---|---|---|---|
| n=1000 | 11.0 / 13.6 / 13.6 | 0.92 / 1.86 / 3.40 | 20 | 21 / 37 / 33 | overlap=0 missing=0 |
| n=10000 | 89.1 / 94.3 / 94.3 | 0.75 / 0.95 / 4.60 | 200 | 201 / 261 / 235 | overlap=0 missing=0 |
...
|---|---|---|---|---|---|---|---|---|---|
| n=1000 | 0 | 0 KiB | 103 | 0 | 103 | 0.00 | 0.08 | 0.000 | 0.79 |
| n=10000 | 0 | 0 KiB | 103 | 0 | 103 | 0.00 | 0.08 | 0.000 | 0.63 |
